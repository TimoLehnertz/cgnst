                ...
                <div id="system">
                    <article class="item">
                        ...
                        <div class="content clearfix">
                            <p><span style="text-decoration: underline;"><strong>Verantwortlich für diese Seite
                                        (www.cstkoeln.de)</strong></span></p>
                            <p>CST Köln e.V.<br>Timo Lehnertz<br>
                            </p>
                            <p><span style="text-decoration: underline;"><strong>Gestaltung der
                                        Rolle</strong></span><br>Thomas Mayer</p>
                            <p>&nbsp;</p>
                            ...
                            <p>Die Betreiber der Seiten sind bemüht, stets die Urheberrechte anderer zu beachten bzw.
                                auf selbst erstellte sowie lizenzfreie Werke zurückzugreifen.</p>
                            <p>Quelle: <a href="http://www.e-recht24.de/" target="_blank" rel="noopener">eRecht24.de</a>
                                - Rechtsberatung von Anwalt Sören Siebert</p>
                        </div>
                    </article>
                </div>
            </div>
