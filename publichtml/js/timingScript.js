window.onload = function(){
    ...
    document.getElementById("triggerKey").innerText = keyboardMap[triggerKeyCode];
    if ("ontouchstart" in document.documentElement){//pc
        document.getElementById("readyStart").innerText = "Tab or press " + keyboardMap[triggerKeyCode] + " to start ";
        document.getElementById("middle").onclick = function(){measurement();};
    } else { //mobile
        document.getElementById("readyStart").innerText = "Press " + keyboardMap[triggerKeyCode] + " to start ";
    }
};
...
function keyDown(e){
    ...
    } else if(e.keyCode == triggerKeyCode && !setKey){
        measurement();
